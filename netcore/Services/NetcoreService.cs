    ...
    public class NetcoreService : INetcoreService
    {
        ...
        public async Task InitCRM()
        {
            try
            {
                ...
                List<OpportunityService> services = new List<OpportunityService>()
                {
                    new OpportunityService{serviceName = "Burial"},
                    new OpportunityService{serviceName = "Cremation"},
                    new OpportunityService{serviceName = "Undecided "},
                };

                _context.OpportunityService.AddRange(services);
               
                //create Opportunity Policy
                List<Policy> policies = new List<Policy>()
                {
                    new Policy{policyName = "SP"},
                    new Policy{policyName = "1P"},
                    new Policy{policyName = "3P "},
                    new Policy{policyName = "5P "},
                    new Policy{policyName = "10P  "},
                    new Policy{policyName = "Annuity"},
                };

                _context.Policy.AddRange(policies);
