...
namespace netcore.Controllers.Crm
{
    ...
    public class AccountExecutiveController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("accountExecutiveId,accountExecutiveName,description,phone,email,street1,street2,city,state,birthDate,zipCode,country,systemUserId,createdAt")] AccountExecutive accountExecutive)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("accountExecutiveId,accountExecutiveName,description,phone,email,street1,street2,city,country,systemUserId,createdAt")] AccountExecutive accountExecutive)
        {
