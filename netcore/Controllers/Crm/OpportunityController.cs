...
namespace netcore.Controllers.Crm
{
    ...
    public class OpportunityController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["serviceId"] = new SelectList(_context.OpportunityService, "serviceId", "serviceName");
            ViewData["policyId"] = new SelectList(_context.Policy, "policyId", "policyName");
        ...
        public async Task<IActionResult> Create([Bind("opportunityId,opportunityName,description,stageId,accountExecutiveId,customerId,estimatedRevenue,estimatedClosingDate,probability,ratingId,serviceId,fundedFlag,policyId,HasChild,createdAt")] Opportunity opportunity)
        {
            ...
            ViewData["serviceId"] = new SelectList(_context.OpportunityService, "serviceId", "serviceName", opportunity.serviceId);
            ViewData["policyId"] = new SelectList(_context.Policy, "policyId", "policyName", opportunity.policyId);
            return View(opportunity);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("opportunityId,opportunityName,description,stageId,accountExecutiveId,customerId,estimatedRevenue,estimatedClosingDate,probability,ratingId,serviceId,fundedFlag,policyId,HasChild,createdAt")] Opportunity opportunity)
        {
